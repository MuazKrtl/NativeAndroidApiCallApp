...
public class RecycleAdapterFavs extends RecyclerView.Adapter<RecycleAdapterFavs.RecycleHolder> {

    private static FavsRecyclerViewClickListener sClickListener;
    ...
    public RecycleAdapterFavs(ArrayList<Cat> arrayListCats, ArrayList<String> arrayListCatsName, FavsRecyclerViewClickListener sClickListener) {
